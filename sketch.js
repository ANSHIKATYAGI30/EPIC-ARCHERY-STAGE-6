...
function handleComputerArrowCollision() {
  ...
  for (var i = 0; i < computerArrows.length; i++) {
    ...
    if(computerArcherLife <= 3){
      ...
      Matter.setPosition(computer.body, {
        x: width -100,
...
//function reduceLife(){
//if (
//   baseCollision.collided ||  archerCollision.collided ||  playerCollision.collided)
// {
//   computerArcherLife -= 1;
//   computer.reduceLife(computerArcherLife);
//   if(computerArcherLife <= 3){
